...
<title>AutoImport Ver.Beta1-BlueXIII</title>
<style type="text/css">
...
<TR>
      <TD align=center width="100%" height=25 style="BACKGROUND-IMAGE: url(img/titlebg.gif); COLOR: #330099; font: 10.5pt"
><B>BlueXIIIStudio  BlueXIII@163.com</B></TD>
</TR>
</TABLE>
</body>
<% end sub %>
...
<table border="0" cellPadding="0" cellSpacing="0" height="100%" width="100%">
  <tr>
    ...
    <iframe frameBorder="0" id="carnoc" name="carnoc" scrolling="yes" src="LeftTree.asp" style="HEIGHT: 100%; VISIBILITY: inherit; WIDTH: 176px; Z-INDEX: 2">
    </iframe>
    </td>
    <td bgcolor="A4B6D7" style="WIDTH: 9pt">
    <table border="0" cellPadding="0" cellSpacing="0" height="100%">
      <tr>
        <td style="HEIGHT: 100%" onClick="switchSysBar()" onmouseover=this.style.cursor="hand">
