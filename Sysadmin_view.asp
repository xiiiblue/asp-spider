...
<table cellpadding="2" cellspacing="1" border="0" width="95%" align="center" class="table_southidc">
  <tr> 
    <td class="back_southidc" colspan="2" height="25" align="center"><b>欢迎您登录 BlueImport 自动录入系统&nbsp;<%=session("username")%></b></td>
  </tr>
  <tr class="tr_southidc">
  	<td>欢迎使用BlueImport自动录入系统！</td>
  </tr>
</table>
<br>
<br>
<table cellpadding="2" cellspacing="1" border="0" width="95%" align="center" class="table_southidc">
  ...
  <tr class="tr_southidc"> 
    <td width="48%" height="23">用户名：<font class="t4"> <%=Session("username")%></font></td>
